...
METHOD_LABELS = {
    "meta_space_xgboost": "MetaSpace XGB",
    "meta_space_rf": "MetaSpace RF",
    "meta_space_logreg": "MetaSpace Reg",
    "meta_space_svm": "MetaSpace SVM",
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="RQ1 report from stored scores: MetaSpace classifiers vs baselines.")
    ...
    p.add_argument(
        "--score-files",
        type=str,
        default="baseline_scores_only.parquet,metaspace_xgboost_61_scores_only.parquet",
    )
...
def main() -> None:
    ...
    saved = [
        ...
        safe_write_table(stats_df, args.out_dir / "rq1_winrate_stats_vs_best_metaspace.csv"),
    ]
    ...
    print(f"\nBest MetaSpace classifier for {base_metric}: {best_label} ({best_method})")
